 ...
 * @since Jul 22, 2014
 */
public class GsonEncodingStringSerializer
implements GsonSerializer<String>
{
	@Override
	...
	@Override
    public JsonElement serialize(String string, Type typeOf, JsonSerializationContext context)
    {
